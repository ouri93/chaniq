...
<html>
    <head>
        ...
        if (GetParentURLParameter('go') == 'new_profile')
            echo '<title>Create Destination Address Affinity Persistence Profile</title>';
        elseif (GetParentURLParameter('go') == 'chg_profile')
            echo '<title>Modify Destination Address Affinity Persistence Profile</title>';
        elseif (GetParentURLParameter('go') == 'del_profile')
            echo '<title>Delete Destination Address Affinity Persistence Profile</title>';
        ?>
