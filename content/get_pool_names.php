...
require_once(__DIR__ . '/../utility/chaniqLogger.php');
    ...
    $logger->info("get_pool_names.php UN: " .$_SESSION['username'] . " Role: " . $_SESSION['role'] . " LoggedIn: " . $_SESSION['loggedin']);
    if ($_SESSION['loggedin'] != true){
        session_unset();
        session_destroy();
        #file_put_contents("/var/log/chaniqphp.log", "get_pool_names.php redirection to login page!!\n", FILE_APPEND);
        $logger->info("get_pool_names.php redirection to login page!!");
    ...
    $logger->info("get_pool_names() - callBack function php has been called");
    ...
    function get_pool_names($logger) {
