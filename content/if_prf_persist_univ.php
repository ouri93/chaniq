...
<html>
    <head>
        ...
        if (GetParentURLParameter('go') == 'new_profile')
            echo '<title>Create Universal Persistence Profile</title>';
        elseif (GetParentURLParameter('go') == 'chg_profile')
            echo '<title>Modify Universal Persistence Profile</title>';
        elseif (GetParentURLParameter('go') == 'del_profile')
            echo '<title>Delete Universal Persistence Profile</title>';
        ?>        
