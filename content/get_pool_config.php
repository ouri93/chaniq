...
$logger->info("get_pool_config.php UN: " .$_SESSION['username'] . " Role: " . $_SESSION['role'] . " LoggedIn: " . $_SESSION['loggedin']);
if ($_SESSION['loggedin'] != true){
    session_unset();
    session_destroy();
    #file_put_contents("/var/log/chaniqphp.log", "get_pool_config.php redirection to login page!!\n", FILE_APPEND);
    $logger->info("get_pool_config.php redirection to login page!!");
...
$logger->info("get_pool_config.php() - callBack function php has been called");
...
if (isset($_POST['jsonPoolData'])){
    ...
    $logger->info("get_pool_config() phpFile: " . $poolData->PhpFileName);
...
function get_pool_config($poolData, $logger) {
    #file_put_contents("/var/log/chaniqphp.log", "get_pool_config() called\n", FILE_APPEND);
    $logger->info("get_pool_config() called");
    ...
    $logger->info("After python call -get_pool_config.php() get_pool_config() function called!");
