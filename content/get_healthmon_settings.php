<?php
    ...
    function get_healthmon_settings() {
        if(isset($_POST['DevIP']))
        {
            ...
            file_put_contents("/var/log/chaniqphp.log", "get_healthmon_settings() Device IP: " . $bigipIP . " Mon Type: " . $monType . " Parent Mon: " . $parMonType, FILE_APPEND);
        }

        $cmd = '/usr/bin/python /var/www/chaniq/py/get_healthmon_settings.py '. $bigipIP . ' ' . $monType . ' ' . $parMonType;
