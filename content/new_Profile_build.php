...
session_start();
#file_put_contents("/var/log/chaniqphp.log", "new_Profile_build.php UN: " .$_SESSION['username'] . " Role: " . $_SESSION['role'] . " LoggedIn: " . $_SESSION['loggedin'] . "\n", FILE_APPEND);
$logger->info("new_Profile_build.php UN: " .$_SESSION['username'] . " Role: " . $_SESSION['role'] . " LoggedIn: " . $_SESSION['loggedin']);
    if ($_SESSION['loggedin'] != true){
        session_unset();
        session_destroy();
        #file_put_contents("/var/log/chaniqphp.log", "new_Profile_build.php redirection to login page!!\n", FILE_APPEND);
        $logger->info("new_Profile_build.php redirection to login page!!");
    ...
    $logger->info("new_Profile_build.php() - callBack function php has been called");
    ...
    if (isset($_POST['newProfileBuild'])){
        ...
        $logger->info("In new_Profile_build.php calling new_Profile_build() fucntion: " . $profileData->phpFileName);
    ...
    function new_Profile_build($profileData, $logger) {
        $cmd = '';
        ...
        $logger->info("new_Profile_build() called. \nDevice IP: " . $prfDevIp . "\nDeploy or Change: " . $prfDplyOrChg . "\nProfile Type:" . $prfType . "\nPhp Filename: " . $phpFileName);
        ...
        if ($prfType == 'DNS'){
            ...
            $logger->info("new_cookieProfile_build() \nDevice IP: " . $prfDevIp . " \nProfile Name: " .$prfName. "\nProfile Deploy or Change: " .$prfDplyOrChg . "\nDefaults-From: " .$prfPara1."\nCookie Method: " .$prfPara2."\nCookie Name: " .$prfPara3."\nHttp Only: " .$prfPara4. "\nSecure Attribute: " .$prfPara5. "\nAlways Send Cookie: " .$prfPara6."\nExpiration: " .$prfPara7."\nOverride Connection Limit: " .$prfPara8);
            $cmd = '/usr/bin/python2 /var/www/chaniq/py/new_cookieProfile_build.py '. escapeshellarg($prfDevIp) .' '. escapeshellarg($prfName) .' '. escapeshellarg($prfDplyOrChg) .' '. escapeshellarg($prfPara1) .' '. escapeshellarg($prfPara2) .' '. escapeshellarg($prfPara3) .' '. escapeshellarg($prfPara4) .' '. escapeshellarg($prfPara5) .' '. escapeshellarg($prfPara6) .' '. escapeshellarg($prfPara7).' '. escapeshellarg($prfPara8);
        }
            ...
            $logger->info("new_dstAffProfile_build() \nDevice IP: " . $prfDevIp . " \nProfile Name: " .$prfName. "\nProfile Deploy or Change: " .$prfDplyOrChg . "\nDefaults-From: " .$prfPara1."\nMatch Across Services: " .$prfPara2."\nMatch Across VSs: " .$prfPara3."\nMatch Across Pools: " .$prfPara4. "\nHash Algo.: " .$prfPara5. "\nTimeout: " .$prfPara6."\nPrefix Length: " .$prfPara7."\nOverride Connection Limit: " .$prfPara8);
            $cmd = '/usr/bin/python2 /var/www/chaniq/py/new_dstAffProfile_build.py '. escapeshellarg($prfDevIp) .' '. escapeshellarg($prfName) .' '. escapeshellarg($prfDplyOrChg) .' '. escapeshellarg($prfPara1) .' '. escapeshellarg($prfPara2) .' '. escapeshellarg($prfPara3) .' '. escapeshellarg($prfPara4) .' '. escapeshellarg($prfPara5) .' '. escapeshellarg($prfPara6) .' '. escapeshellarg($prfPara7).' '. escapeshellarg($prfPara8);
        }
            ...
            $logger->info("new_srcAffProfile_build() \nDevice IP: " . $prfDevIp . " \nProfile Name: " .$prfName. "\nProfile Deploy or Change: " .$prfDplyOrChg . "\nDefaults-From: " .$prfPara1."\nMatch Across Services: " .$prfPara2."\nMatch Across VSs: " .$prfPara3."\nMatch Across Pools: " .$prfPara4. "\nHash Algo.: " .$prfPara5. "\nTimeout: " .$prfPara6."\nPrefix Length: " .$prfPara7. "\nMap Proxies:" .$prfPara8."\nOverride Connection Limit: " .$prfPara9);
            $cmd = '/usr/bin/python2 /var/www/chaniq/py/new_srcAffProfile_build.py '. escapeshellarg($prfDevIp) .' '. escapeshellarg($prfName) .' '. escapeshellarg($prfDplyOrChg) .' '. escapeshellarg($prfPara1) .' '. escapeshellarg($prfPara2) .' '. escapeshellarg($prfPara3) .' '. escapeshellarg($prfPara4) .' '. escapeshellarg($prfPara5) .' '. escapeshellarg($prfPara6) .' '. escapeshellarg($prfPara7).' '. escapeshellarg($prfPara8).' '. escapeshellarg($prfPara9);
        }
            ...
            $logger->info("new_sslProfile_build() \nDevice IP: " . $prfDevIp . " \nProfile Name: " .$prfName. "\nProfile Deploy or Change: " .$prfDplyOrChg . "\nDefaults-From: " .$prfPara1."\nMatch Across Services: " .$prfPara2."\nMatch Across VSs: " .$prfPara3."\nMatch Across Pools: " .$prfPara4. "\nTimeout: " .$prfPara5. "\nOverride Connection Limit: " .$prfPara6);
            $cmd = '/usr/bin/python2 /var/www/chaniq/py/new_sslProfile_build.py '. escapeshellarg($prfDevIp) .' '. escapeshellarg($prfName) .' '. escapeshellarg($prfDplyOrChg) .' '. escapeshellarg($prfPara1) .' '. escapeshellarg($prfPara2) .' '. escapeshellarg($prfPara3) .' '. escapeshellarg($prfPara4) .' '. escapeshellarg($prfPara5) .' '. escapeshellarg($prfPara6);
            ...
            $logger->info("new_uniProfile_build() \nDevice IP: " . $prfDevIp . " \nProfile Name: " .$prfName. "\nProfile Deploy or Change: " .$prfDplyOrChg . "\nDefaults-From: " .$prfPara1."\nMatch Across Services: " .$prfPara2."\nMatch Across VSs: " .$prfPara3."\nMatch Across Pools: " .$prfPara4. "\nTimeout: " .$prfPara5. "\nRule: " .$prfPara6. "\nOverride Connection Limit: " .$prfPara7);
            $cmd = '/usr/bin/python2 /var/www/chaniq/py/new_uniProfile_build.py '. escapeshellarg($prfDevIp) .' '. escapeshellarg($prfName) .' '. escapeshellarg($prfDplyOrChg) .' '. escapeshellarg($prfPara1) .' '. escapeshellarg($prfPara2) .' '. escapeshellarg($prfPara3) .' '. escapeshellarg($prfPara4) .' '. escapeshellarg($prfPara5) .' '. escapeshellarg($prfPara6) .' '. escapeshellarg($prfPara7);
            ...
            $logger->info("new_f4Profile_build() \nDevice IP: " . $prfDevIp . " \nProfile Name: " .$prfName. "\nProfile Deploy or Change: " .$prfDplyOrChg . "\nDefaults-From: " .$prfPara1."\nReset on Timeout: " .$prfPara2."\nReassemble IP Fragment: " .$prfPara3."\nIdle Timeout: " .$prfPara4. "\nTCP Handshake Timeout: " .$prfPara5. "\nTCP Timestamp Mode: " .$prfPara6. "\nTCP Window Scale Mode: " .$prfPara7. "\nLoose Initiation: " .$prfPara8. "\nLoose Close: " .$prfPara9."\nTCP Close Timeout: " .$prfPara10."\nTCP Keep Alive Interval: " .$prfPara11);
            $cmd = '/usr/bin/python2 /var/www/chaniq/py/new_f4Profile_build.py '. escapeshellarg($prfDevIp) .' '. escapeshellarg($prfName) .' '. escapeshellarg($prfDplyOrChg) .' '. escapeshellarg($prfPara1) .' '. escapeshellarg($prfPara2) .' '. escapeshellarg($prfPara3) .' '. escapeshellarg($prfPara4) .' '. escapeshellarg($prfPara5) .' '. escapeshellarg($prfPara6) .' '. escapeshellarg($prfPara7).' '. escapeshellarg($prfPara8).' '. escapeshellarg($prfPara9).' '. escapeshellarg($prfPara10).' '. escapeshellarg($prfPara11);
            ...
            $logger->info("new_tcpProfile_build() \nDevice IP: " . $prfDevIp . " \nProfile Name: " .$prfName. "\nProfile Deploy or Change: " .$prfDplyOrChg . "\nDefaults-From: " .$prfPara1."\nReset on Timeout: " .$prfPara2."\nProxy Buffer High: " .$prfPara3."\nProxy Buffer Low: " .$prfPara4. "\nReceive Window: " .$prfPara5. "\nSend Buffer: " .$prfPara6. "\nAcknowledge on Push: " .$prfPara7. "\nNagle's Algorithm: " .$prfPara8. "\nInitial Congestion Window Size: " .$prfPara9."\nSlow Start: " .$prfPara10."\nSelective ACKs: " .$prfPara11);
            $cmd = '/usr/bin/python2 /var/www/chaniq/py/new_tcpProfile_build.py '. escapeshellarg($prfDevIp) .' '. escapeshellarg($prfName) .' '. escapeshellarg($prfDplyOrChg) .' '. escapeshellarg($prfPara1) .' '. escapeshellarg($prfPara2) .' '. escapeshellarg($prfPara3) .' '. escapeshellarg($prfPara4) .' '. escapeshellarg($prfPara5) .' '. escapeshellarg($prfPara6) .' '. escapeshellarg($prfPara7).' '. escapeshellarg($prfPara8).' '. escapeshellarg($prfPara9).' '. escapeshellarg($prfPara10).' '. escapeshellarg($prfPara11);
            ...
            $logger->info("new_udpProfile_build() \nDevice IP: " . $prfDevIp . " \nProfile Name: " .$prfName. "\nProfile Deploy or Change: " .$prfDplyOrChg . "\nDefaults-From: " .$prfPara1."\nProxy Maximum Segment: " .$prfPara2."\nIdle Timeout: " .$prfPara3."\nIP ToS: " .$prfPara4. "\nLink QoS: " .$prfPara5. "\nDatagram LB: " .$prfPara6. "\nAllow No Pyaload: " .$prfPara7. "\nTTL Mode: " .$prfPara8. "\nTTL IPv4: " .$prfPara9."\nTTL IPv6: " .$prfPara10."\nDon't Fragment Mode: " .$prfPara11);
            $cmd = '/usr/bin/python2 /var/www/chaniq/py/new_udpProfile_build.py '. escapeshellarg($prfDevIp) .' '. escapeshellarg($prfName) .' '. escapeshellarg($prfDplyOrChg) .' '. escapeshellarg($prfPara1) .' '. escapeshellarg($prfPara2) .' '. escapeshellarg($prfPara3) .' '. escapeshellarg($prfPara4) .' '. escapeshellarg($prfPara5) .' '. escapeshellarg($prfPara6) .' '. escapeshellarg($prfPara7).' '. escapeshellarg($prfPara8).' '. escapeshellarg($prfPara9).' '. escapeshellarg($prfPara10).' '. escapeshellarg($prfPara11);
            ...
            $logger->info("new_srvsslProfile_build() \nDevice IP: " . $prfDevIp . " \nProfile Name: " .$prfName. "\nProfile Deploy or Change: " .$prfDplyOrChg . "\nDefaults-From: " .$prfPara1."\nCertificate: " .$prfPara2."\nKey: " .$prfPara3."\nChain: " .$prfPara4. "\nCiphers: " .$prfPara5. "\nproxy SSL: " .$prfPara6. "\nProxsy SSL Pass-through: " .$prfPara7. "\nRenegotiation: " .$prfPara8. "\nRenegotiate Period: " .$prfPara9."\nRenegotiate Size: " .$prfPara10."\nSecure Renegotiation: " .$prfPara11."\nServer Name: " .$prfPara12."\nDefault SSL Profile for SNI: " .$prfPara13."\nRequire Peer SNI support: " .$prfPara14);
            $cmd = '/usr/bin/python2 /var/www/chaniq/py/new_srvsslProfile_build.py '. escapeshellarg($prfDevIp) .' '. escapeshellarg($prfName) .' '. escapeshellarg($prfDplyOrChg) .' '. escapeshellarg($prfPara1) .' '. escapeshellarg($prfPara2) .' '. escapeshellarg($prfPara3) .' '. escapeshellarg($prfPara4) .' '. escapeshellarg($prfPara5) .' '. escapeshellarg($prfPara6) .' '. escapeshellarg($prfPara7).' '. escapeshellarg($prfPara8).' '. escapeshellarg($prfPara9).' '. escapeshellarg($prfPara10).' '. escapeshellarg($prfPara11).' '. escapeshellarg($prfPara12).' '. escapeshellarg($prfPara13).' '. escapeshellarg($prfPara14);
        }
            ...
            $logger->info("new_ocProfile_build() \nDevice IP: " . $prfDevIp . " \nProfile Name: " .$prfName. "\nProfile Deploy or Change: " .$prfDplyOrChg . "\nDefaults-From: " .$prfPara1."\nSource Prefix Length: " .$prfPara2."\nMaximum Size: " .$prfPara3."\nMaximum Age: " .$prfPara4. "\nMaximum Reuse: " .$prfPara5. "\nIdle Timeout Override: " .$prfPara6. "\nLimit Type: " .$prfPara7);
            $cmd = '/usr/bin/python2 /var/www/chaniq/py/new_ocProfile_build.py '. escapeshellarg($prfDevIp) .' '. escapeshellarg($prfName) .' '. escapeshellarg($prfDplyOrChg) .' '. escapeshellarg($prfPara1) .' '. escapeshellarg($prfPara2) .' '. escapeshellarg($prfPara3) .' '. escapeshellarg($prfPara4) .' '. escapeshellarg($prfPara5) .' '. escapeshellarg($prfPara6) .' '. escapeshellarg($prfPara7);
            ...
            $logger->info("new_streamProfile_build() \nDevice IP: " . $prfDevIp . " \nProfile Name: " .$prfName. "\nProfile Deploy or Change: " .$prfDplyOrChg . "\nDefaults-From: " .$prfPara1."\nSource: " .$prfPara2."\nTarget: " .$prfPara3);
            $cmd = '/usr/bin/python2 /var/www/chaniq/py/new_streamProfile_build.py '. escapeshellarg($prfDevIp) .' '. escapeshellarg($prfName) .' '. escapeshellarg($prfDplyOrChg) .' '. escapeshellarg($prfPara1) .' '. escapeshellarg($prfPara2) .' '. escapeshellarg($prfPara3);
            
        }
        
        $output = shell_exec($cmd);
        #error_log(date("y-m-d H:i:s").": After python call - new_Profile_build.php() new_Profile_build() function called!\n", 3, "/var/log/chaniqphp.log");
        $logger->info("After python call - new_Profile_build.php() new_Profile_build() function called!");
