...
<html>
    <head>
        ...
        if (GetParentURLParameter('go') == 'new_profile')
            echo '<title>Create Source Address Affinity Persistence Profile</title>';
        elseif (GetParentURLParameter('go') == 'chg_profile')
            echo '<title>Modify Source Address Affinity Persistence Profile</title>';
        elseif (GetParentURLParameter('go') == 'del_profile')
            echo '<title>Delete Source Address Affinity Persistence Profile</title>';
        ?>
