...
def new_tcpProfile_build(active_ltm, prfName, prfDplyOrChg, defaultsFrom, resetOnTimeout, proxyBufferHigh, proxyBufferLow, receiveWindowSize, sendBufferSize, ackOnPush, nagle, initCwnd, slowStart, selectiveAcks):
    ...
    logger.info("new_tcpProfile_build()- Use Standard Global naming : " + useGlobalNaming )
    
    logger.info("new_tcpProfile_build.py Parms DevIP: " + active_ltm + " Profile name: " + prfName + " Profile Deploy or Change: " + prfDplyOrChg + " Defaults-from: " + defaultsFrom) 
    idx = 1
    ...
    if prfDplyOrChg == 'new_profile': 
        ...
        logger.info("Profile Creation process has been initiated. TCP Profile Name: " + prfName)
        ...
        logger.info("Profile Modification process has been initiated. TCP Profile Name: " + prfName)
        ...
        try:
            ...
            idx += 1
            logger.info("Exception fired during TCP Profile setting loading! ( " + str(e) + ")")
            return json.dumps(strReturn)
