...
def new_clisslProfile_build(active_ltm, prfName, prfDplyOrChg, defaultsFrom, cert, key, chain, ciphers, proxySsl, proxySslPassthrough, renegotiation, renegotiatePeriod, renegotiateSize, renegotiateMaxRecordDelay, secureRenegotiation, maxRenegotiationsPerMinute, serverName, sniDefault, sniRequire):
    ...
    logger.info("new_clisslProfile_build()- Use Standard Global naming : " + useGlobalNaming )
    
    logger.info("new_clisslProfile_build.py Parms DevIP: " + active_ltm + " Profile name: " + prfName + " Profile Deploy or Change: " + prfDplyOrChg + " Defaults-from: " + defaultsFrom) 
    idx = 1
    ...
    if prfDplyOrChg == 'new_profile':
        ...
        logger.info("Profile Creation process has been initiated. ClientSSL Profile Name: " + prfName)
        ...
        try:
            ...
            idx += 1
            logger.info("ClientSSL Profile creation exception fired: " + str(e))
            return json.dumps(strReturn)
        ...
        logger.info("Profile Modification process has been initiated. ClientSSL Profile Name: " + prfName)
        ...
        try:
            ...
            idx += 1
            logger.info("Exception fired during Client SSL Profile setting loading! ( " + str(e) + ")")
            return json.dumps(strReturn)
        ...
        if isNeedUpdate(loadedPrf, modContent, defaultsFrom, certKeyChain, ciphers, proxySsl, proxySslPassthrough, renegotiation, renegotiatePeriod, renegotiateSize, renegotiateMaxRecordDelay, secureRenegotiation, maxRenegotiationsPerMinute, serverName, sniDefault, sniRequire):
            ...
            try:
                ...
                idx += 1
                logger.info("Client SSL Profile Modification exception fired: " + str(e))
                return json.dumps(strReturn)
        else:
